...
// Simplified SVG wrappers for standard icons used
...
export const Twitter = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-12.7 12.5S.2 5.3 4.1 2c2-1.7 4.1 0 4.1 0s-.4 3.3.7 3.3c1.3 0 2.7-1.3 3-2 1.3-3.3 5.3-2.7 6.2 1.3 2.5 1.1 5.4.1 5.4.1l-1.5 2.6c1.6 1 3.2.2 3.2.2z"/></svg>
);
